...
<html lang="en">
  <head>
    ...
    <title>Daftar &mdash; Web Pembayaran UKT</title>
                  ...
                  <form action="proses_register.php" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="nama_petugas" class="form-control" placeholder="Nama Lengkap Petugas/Admin" required="required">
                      </div>
                    </div>
