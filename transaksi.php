        ...
        <section class="section">
         ...
         <div class="row">
            ...
            <span class="input-group-text" id="basic-addon1">NIM</span>
                ...
                <input type="text" name="nisn" class="form-control" placeholder="nim" aria-label="masukkan nim" aria-describedby="basic-addon1">
                </div>
            ...
            <span class="input-group-text" id="basic-addon1">Tanggal Bayar</span>
              ...
              <div class="input-group mb-3">
             <div class="input-group-prepend">
            <span class="input-group-text" id="basic-addon1">ID UKT</span>
               </div>
                <input type="text" name="id_spp" class="form-control" placeholder="id pembayaran ukt" aria-label="masukkan id" aria-describedby="basic-addon1">
                </div>
